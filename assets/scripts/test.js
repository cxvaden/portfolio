...
function MovieSearch() { 
  ...
  var api_key = "09a7f2a2dddc210e0b53ee4c5170bd57"; // add your TMDb API key // add your TMDb API key
  var language = "en-US";
  var page = "1";
...
function MovieDtlCrdSearch() {
  ...
  /* Build up the parameters for the URL */
  var txt
  var api_key = "09a7f2a2dddc210e0b53ee4c5170bd57"; // add your TMDb API key
  var language = "en-US";
  var page = "1";
  var include_adult = "false";
  ...
  $(document).ready(function() { 
    ...
    .done(function(msg) {
      ...
      // Get Movie Credits
      // Loop through the first 7 results
      for (i = 0; i < 8; i++) {
        /* Display the result */
